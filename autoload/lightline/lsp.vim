...
function! lightline#lsp#hints() abort
  ...
  let l:counts = luaeval('#vim.diagnostic.get('.bufnr().', { severity = vim.diagnostic.severity.HINT })')
...
function! lightline#lsp#infos() abort
  ...
  let l:counts = luaeval('#vim.diagnostic.get('.bufnr().', { severity = vim.diagnostic.severity.INFO })')
...
function! lightline#lsp#warnings() abort
  ...
  let l:counts = luaeval('#vim.diagnostic.get('.bufnr().', { severity = vim.diagnostic.severity.WARN })')
...
function! lightline#lsp#errors() abort
  ...
  let l:counts = luaeval('#vim.diagnostic.get('.bufnr().', { severity = vim.diagnostic.severity.ERROR })')
...
function! lightline#lsp#ok() abort
  ...
  let l:hint_counts = luaeval('#vim.diagnostic.get('.bufnr().', { severity = vim.diagnostic.severity.HINT })')
  let l:info_counts = luaeval('#vim.diagnostic.get('.bufnr().', { severity = vim.diagnostic.severity.INFO })')
  let l:warn_counts = luaeval('#vim.diagnostic.get('.bufnr().', { severity = vim.diagnostic.severity.WARN })')
  let l:error_counts = luaeval('#vim.diagnostic.get('.bufnr().', { severity = vim.diagnostic.severity.ERROR })')
